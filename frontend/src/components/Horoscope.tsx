...
const FB: Record<string,string[]> = {
  aries:['♈ Овен: Звёзды на твоей стороне. Риски оправдаются. Доверяй интуиции!','♈ Овен: Энергия бьёт ключом — направь её в дело.','♈ Овен: День перемен. Препятствие станет трамплином.'],
